...
- [ ] T046 [US1] JWT の検証が、`ACCESS_AUD` のカンマ区切りの AUD タグのどれかに一致する JWT を通すようにし、単体テストに2つの AUD のそれぞれで通ることを足す（research.md の R2） in src/features/note/server/author.ts と tests/unit/note-author.test.ts
